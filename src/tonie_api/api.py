    ...
    def __init__(
        ...
        *,
        ...
        if session is not None:
            ...
            username = username or os.environ.get("TONIE_USERNAME") or os.environ.get("USERNAME")
            password = password or os.environ.get("TONIE_PASSWORD") or os.environ.get("PASSWORD")
